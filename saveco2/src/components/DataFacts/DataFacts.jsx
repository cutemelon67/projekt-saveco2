...
export const dataFacts = ({ heading, src, alt, text }) => {
  return (
    <>
      <h2>Víte, že...</h2>
      <div className="dataFacts__container">
        <h3 className="dataFacts__heading">{heading}</h3>
        <img className="dataFacts__img" src={src} alt={alt} />
        <p className="dataFacts__text">{text}</p>
      </div>
    </>
  );
};

const dataFactsContent = {
